...
const SuperQuality = () => {
  return ( 
    <section if="about us" className="flex justify-between items-center max-lg:flex-col  gap-10 w-full max-container">
...
<div className="flex flex-1 flex-col">
        ...
        <div className="flex-1 flex justify-center items-center">
          <img src={shoe8} alt="shoe8"  width={600} height={522} className="object-contain"/>
        </div>
